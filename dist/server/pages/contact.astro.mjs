...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Contact", "description": "Contactez Univers Glass par telephone, WhatsApp ou email.", "data-astro-cid-uw5kdbxl": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="home-shell" data-astro-cid-uw5kdbxl> <section class="hero-card" data-astro-cid-uw5kdbxl> <div class="hero-main" data-astro-cid-uw5kdbxl> <div class="hero-copy" data-astro-cid-uw5kdbxl> <div class="hero-copy__bg" aria-hidden="true" data-astro-cid-uw5kdbxl></div> <a class="brand-lockup" href="/" aria-label="Univers Glass" data-astro-cid-uw5kdbxl> <img class="brand-lockup__logo" src="/goodlogo.png" alt="" aria-hidden="true" width="682" height="366" loading="eager" decoding="async" data-astro-cid-uw5kdbxl> </a> <h1 class="hero-title" data-astro-cid-uw5kdbxl> <span data-astro-cid-uw5kdbxl>CONTACTEZ</span> <span class="hero-title--accent" data-astro-cid-uw5kdbxl>UNIVERS</span> <span data-astro-cid-uw5kdbxl>GLASS</span> </h1> <span class="hero-rule" aria-hidden="true" data-astro-cid-uw5kdbxl></span> <p class="hero-description" data-astro-cid-uw5kdbxl>
